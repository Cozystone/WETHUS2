...
- Project hub integration APIs can be protected with `INTEGRATIONS_REQUIRE_ACTOR=true`; this is an interim boundary until project membership authorization moves to the database.
